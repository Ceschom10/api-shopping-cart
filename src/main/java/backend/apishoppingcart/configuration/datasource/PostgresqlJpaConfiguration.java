package backend.apishoppingcart.configuration.datasource;
...
@EnableJpaRepositories(basePackages = {"backend.apishoppingcart" }, 
...
public class PostgresqlJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean postgressqlEntityManagerFactory(
		...
		return builder.dataSource(dataSource).properties(props).packages("backend.apishoppingcart").build();
	}
