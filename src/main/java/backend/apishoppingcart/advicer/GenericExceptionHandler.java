package backend.apishoppingcart.advicer;
...
import backend.apishoppingcart.component.exception.GenericException;
import backend.apishoppingcart.component.util.log.LogUtil;
import backend.apishoppingcart.component.util.log.LogUtilImpl;
...
public class GenericExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    WebRequest request) {
        ...
        GenericException apiError = 
            new GenericException(HttpStatus.BAD_REQUEST, headers, 
